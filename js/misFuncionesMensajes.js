...
function autoInicioMensajes(){
    ...
    $.ajax({
        url:"http://158.101.32.195:8080/api/Message/all",
...
function guardarInformacionMensajes(){
    ...
    let var2 = {
        ...
        url:"http://158.101.32.195:8080/api/Message/save",
...
function actualizarInformacionMensaje(idElemento){
    ...
    $.ajax({
        url:"http://158.101.32.195:8080/api/Message/update",
...
function borrarMensaje(idElemento){
    ...
    $.ajax({
        url:"http://158.101.32.195:8080/api/Message/"+idElemento,
